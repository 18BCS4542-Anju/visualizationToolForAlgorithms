...
export function Controller() {
  ...
  const startElement = (
    <VscDebugStart onClick={startSorting} style={{ color: "#E33E7F" }} />
  );
  const pauseElement = <ImPause onClick={pauseAndDelaySorting} />;
  const resetElement = (
    <VscDebugRestart onClick={resetSorting} style={{ color: "#E33E7F" }} />
  );
  const disabledPauseElement = <ImPause style={{ color: "#000" }} />;
